...
//        System.out.println(gengar.getCurrentSpc() + " / " + gengar.getSpc());
        ...
        Trainer trainer1 = new Trainer(UUID.randomUUID(), "Ash", requestNewRentalPokemon("GOLEM"), requestNewRentalPokemon("CHARIZARD"), null, null, null, null);
        Trainer trainer2 = new Trainer(UUID.randomUUID(), "Gary", requestNewRentalPokemon("GYARADOS"), requestNewRentalPokemon("NIDOKING"), null, null, null, null);
